...
/**
 * This class extends {@link AzureResource} for any resource which is represented by a blob on the service.
 */
class AzureResourceBlob extends AzureResource{
    private final ClientLogger logger = new ClientLogger(AzureResourceBlob.class);
    ...
    AzureResourceBlob(AzurePath path) throws IOException {
        super(path);
