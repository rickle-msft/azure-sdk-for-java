...
import com.microsoft.azure.storage.file.models.ListHandlesResponse;
...
public final class GeneratedDirectorys {
    ...
    private interface DirectorysService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(StorageErrorException.class)
        Single<DirectoryListHandlesResponse> listHandles(Context context, @HostParam("url") String url, @QueryParam("marker") String marker, @QueryParam("maxresults") Integer maxresults, @QueryParam("timeout") Integer timeout, @QueryParam("sharesnapshot") String sharesnapshot, @HeaderParam("x-ms-recursive") Boolean recursive, @HeaderParam("x-ms-version") String version, @QueryParam("comp") String comp);

        @PUT("{shareName}/{directory}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(StorageErrorException.class)
        Single<DirectoryForceCloseHandlesResponse> forceCloseHandles(Context context, @HostParam("url") String url, @QueryParam("timeout") Integer timeout, @QueryParam("marker") String marker, @QueryParam("sharesnapshot") String sharesnapshot, @HeaderParam("x-ms-handle-id") String handleId, @HeaderParam("x-ms-recursive") Boolean recursive, @HeaderParam("x-ms-version") String version, @QueryParam("comp") String comp);
    }
     ...
     * @throws StorageErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the ListHandlesResponse object if successful.
     */
    public ListHandlesResponse listHandles(Context context, String marker, Integer maxresults, Integer timeout, String sharesnapshot, Boolean recursive) {
        return listHandlesAsync(context, marker, maxresults, timeout, sharesnapshot, recursive).blockingGet();
    }
     ...
     * @return a ServiceFuture which will be completed with the result of the network request.
     */
    public ServiceFuture<ListHandlesResponse> listHandlesAsync(Context context, String marker, Integer maxresults, Integer timeout, String sharesnapshot, Boolean recursive, ServiceCallback<ListHandlesResponse> serviceCallback) {
        return ServiceFuture.fromBody(listHandlesAsync(context, marker, maxresults, timeout, sharesnapshot, recursive), serviceCallback);
    }
     ...
     * @return a Single which performs the network request upon subscription.
     */
    public Single<DirectoryListHandlesResponse> listHandlesWithRestResponseAsync(Context context, String marker, Integer maxresults, Integer timeout, String sharesnapshot, Boolean recursive) {
        if (this.client.url() == null) {
            throw new IllegalArgumentException("Parameter this.client.url() is required and cannot be null.");
        }
        if (this.client.version() == null) {
        ...
        return service.listHandles(context, this.client.url(), marker, maxresults, timeout, sharesnapshot, recursive, this.client.version(), comp);
    }
     ...
     * @return a Single which performs the network request upon subscription.
     */
    public Maybe<ListHandlesResponse> listHandlesAsync(Context context, String marker, Integer maxresults, Integer timeout, String sharesnapshot, Boolean recursive) {
        return listHandlesWithRestResponseAsync(context, marker, maxresults, timeout, sharesnapshot, recursive)
            .flatMapMaybe((DirectoryListHandlesResponse res) -> res.body() == null ? Maybe.empty() : Maybe.just(res.body()));
    }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    public void forceCloseHandles(Context context, @NonNull String handleId, Integer timeout, String marker, String sharesnapshot, Boolean recursive) {
        forceCloseHandlesAsync(context, handleId, timeout, marker, sharesnapshot, recursive).blockingAwait();
    }
     ...
     * @return a ServiceFuture which will be completed with the result of the network request.
     */
    public ServiceFuture<Void> forceCloseHandlesAsync(Context context, @NonNull String handleId, Integer timeout, String marker, String sharesnapshot, Boolean recursive, ServiceCallback<Void> serviceCallback) {
        return ServiceFuture.fromBody(forceCloseHandlesAsync(context, handleId, timeout, marker, sharesnapshot, recursive), serviceCallback);
    }
     ...
     * @return a Single which performs the network request upon subscription.
     */
    public Single<DirectoryForceCloseHandlesResponse> forceCloseHandlesWithRestResponseAsync(Context context, @NonNull String handleId, Integer timeout, String marker, String sharesnapshot, Boolean recursive) {
        if (this.client.url() == null) {
            throw new IllegalArgumentException("Parameter this.client.url() is required and cannot be null.");
        }
        if (handleId == null) {
            throw new IllegalArgumentException("Parameter handleId is required and cannot be null.");
        }
        if (this.client.version() == null) {
            throw new IllegalArgumentException("Parameter this.client.version() is required and cannot be null.");
        }
        final String comp = "forceclosehandles";
        return service.forceCloseHandles(context, this.client.url(), timeout, marker, sharesnapshot, handleId, recursive, this.client.version(), comp);
    }
     ...
     * @return a Single which performs the network request upon subscription.
     */
    public Completable forceCloseHandlesAsync(Context context, @NonNull String handleId, Integer timeout, String marker, String sharesnapshot, Boolean recursive) {
        return forceCloseHandlesWithRestResponseAsync(context, handleId, timeout, marker, sharesnapshot, recursive)
            .toCompletable();
    }
}
