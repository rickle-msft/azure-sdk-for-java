...
public final class DirectoryListHandlesHeaders {
     ...
     */
    public DirectoryListHandlesHeaders withContentType(String contentType) {
     ...
     * @return the DirectoryListHandlesHeaders object itself.
     */
    public DirectoryListHandlesHeaders withRequestId(String requestId) {
     ...
     * @return the DirectoryListHandlesHeaders object itself.
     */
    public DirectoryListHandlesHeaders withVersion(String version) {
     ...
     * @return the DirectoryListHandlesHeaders object itself.
     */
    public DirectoryListHandlesHeaders withDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
