...
public final class FileListHandlesHeaders {
     ...
     */
    public FileListHandlesHeaders withContentType(String contentType) {
     ...
     * @return the FileListHandlesHeaders object itself.
     */
    public FileListHandlesHeaders withRequestId(String requestId) {
     ...
     * @return the FileListHandlesHeaders object itself.
     */
    public FileListHandlesHeaders withVersion(String version) {
     ...
     * @return the FileListHandlesHeaders object itself.
     */
    public FileListHandlesHeaders withDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
