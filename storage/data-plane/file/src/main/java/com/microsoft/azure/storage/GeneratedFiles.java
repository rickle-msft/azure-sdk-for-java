...
import com.microsoft.azure.storage.file.models.FileForceCloseHandlesResponse;
...
import com.microsoft.azure.storage.file.models.FileListHandlesResponse;
...
public final class GeneratedFiles {
    ...
    private interface FilesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(StorageErrorException.class)
        Single<FileListHandlesResponse> listHandles(Context context, @HostParam("url") String url, @QueryParam("marker") String marker, @QueryParam("maxresults") Integer maxresults, @QueryParam("timeout") Integer timeout, @QueryParam("sharesnapshot") String sharesnapshot, @HeaderParam("x-ms-version") String version, @QueryParam("comp") String comp);

        @PUT("{shareName}/{directory}/{fileName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(StorageErrorException.class)
        Single<FileForceCloseHandlesResponse> forceCloseHandles(Context context, @HostParam("url") String url, @QueryParam("timeout") Integer timeout, @QueryParam("marker") String marker, @QueryParam("sharesnapshot") String sharesnapshot, @HeaderParam("x-ms-handle-id") String handleId, @HeaderParam("x-ms-version") String version, @QueryParam("comp") String comp);
    }
     ...
     */
    public ListHandlesResponse listHandles(Context context, String marker, Integer maxresults, Integer timeout, String sharesnapshot) {
        return listHandlesAsync(context, marker, maxresults, timeout, sharesnapshot).blockingGet();
    }
     ...
     * @return a ServiceFuture which will be completed with the result of the network request.
     */
    public ServiceFuture<ListHandlesResponse> listHandlesAsync(Context context, String marker, Integer maxresults, Integer timeout, String sharesnapshot, ServiceCallback<ListHandlesResponse> serviceCallback) {
        return ServiceFuture.fromBody(listHandlesAsync(context, marker, maxresults, timeout, sharesnapshot), serviceCallback);
    }
     ...
     * @return a Single which performs the network request upon subscription.
     */
    public Single<FileListHandlesResponse> listHandlesWithRestResponseAsync(Context context, String marker, Integer maxresults, Integer timeout, String sharesnapshot) {
        if (this.client.url() == null) {
            throw new IllegalArgumentException("Parameter this.client.url() is required and cannot be null.");
        }
        if (this.client.version() == null) {
        ...
        return service.listHandles(context, this.client.url(), marker, maxresults, timeout, sharesnapshot, this.client.version(), comp);
    }
     ...
     * @return a Single which performs the network request upon subscription.
     */
    public Maybe<ListHandlesResponse> listHandlesAsync(Context context, String marker, Integer maxresults, Integer timeout, String sharesnapshot) {
        return listHandlesWithRestResponseAsync(context, marker, maxresults, timeout, sharesnapshot)
            .flatMapMaybe((FileListHandlesResponse res) -> res.body() == null ? Maybe.empty() : Maybe.just(res.body()));
    }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    public void forceCloseHandles(Context context, @NonNull String handleId, Integer timeout, String marker, String sharesnapshot) {
        forceCloseHandlesAsync(context, handleId, timeout, marker, sharesnapshot).blockingAwait();
    }
     ...
     * @return a ServiceFuture which will be completed with the result of the network request.
     */
    public ServiceFuture<Void> forceCloseHandlesAsync(Context context, @NonNull String handleId, Integer timeout, String marker, String sharesnapshot, ServiceCallback<Void> serviceCallback) {
        return ServiceFuture.fromBody(forceCloseHandlesAsync(context, handleId, timeout, marker, sharesnapshot), serviceCallback);
    }
     ...
     * @return a Single which performs the network request upon subscription.
     */
    public Single<FileForceCloseHandlesResponse> forceCloseHandlesWithRestResponseAsync(Context context, @NonNull String handleId, Integer timeout, String marker, String sharesnapshot) {
        if (this.client.url() == null) {
            throw new IllegalArgumentException("Parameter this.client.url() is required and cannot be null.");
        }
        if (handleId == null) {
        ...
        return service.forceCloseHandles(context, this.client.url(), timeout, marker, sharesnapshot, handleId, this.client.version(), comp);
    }
     ...
     * @return a Single which performs the network request upon subscription.
     */
    public Completable forceCloseHandlesAsync(Context context, @NonNull String handleId, Integer timeout, String marker, String sharesnapshot) {
        return forceCloseHandlesWithRestResponseAsync(context, handleId, timeout, marker, sharesnapshot)
            .toCompletable();
    }
}
