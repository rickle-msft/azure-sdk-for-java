...
/**
 * {@code RetryableDownloadResponse} wraps the protocol-layer response from {@link BlobURL#download(BlobRange,
 ...
 */
public class RetryableDownloadResponse extends DownloadResponse {

    private final Function<HTTPGetterInfo, Single<? extends DownloadResponse>> getter;

    public RetryableDownloadResponse(RestResponse<BlobDownloadHeaders, Flowable<ByteBuffer>> response, HTTPGetterInfo info,
            Function<HTTPGetterInfo, Single<? extends DownloadResponse>> getter) {
        super(response, info);
